...
class CPersonal():
    ...
    def create_myinfor(self):
        ...
        if utype == 100:
            ...
            # 填写个人信息到数据库
            add_personal_abo = self.spersonal.add_student_abo_by_uid(str(uuid.uuid4()), args["Uid"], form["Sname"],
                                                                     form["Sno"],
            ...
            # 填写个人信息到数据库
            add_personal_abo = self.spersonal.add_teacher_abo_by_uid(str(uuid.uuid4()), args["Uid"], form["Tname"],
    ...
    def create_mytech(self):
        ...
        if utype == 100:
            ...
            for row in form:
                ...
                # 写入技能
                add_personal_tech = self.spersonal.add_student_tech_by_sid(str(uuid.uuid4()), sid, row["STname"],
                                                                           row["STlevel"])
    ...
    def create_myuse(self):
        ...
        if utype == 100:
            ...
            for row in form:
                ...
                # 写入数据库
                add_personal_use = self.spersonal.add_student_use_by_sid(str(uuid.uuid4()), sid, row["SCname"],
                                                                         row["SCno"])
            ...
            for row in form:
                ...
                # 写入数据库
                add_personal_use = self.spersonal.add_teacher_use_by_tid(str(uuid.uuid4()), tid, row["TCname"],
                                                                         row["TCno"], row["TCnum"])
                if not add_personal_use:
                    return system_error
            return add_personal_use_success
